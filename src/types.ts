...
// ------------------------------------------------------------------------------------------------
// 11. Flashcard Proposal ViewModel
//     Extended model representing the state of a flashcard proposal in the UI.
//     Allows dynamic setting of the source field when sending data to the /flashcards endpoint.
// ------------------------------------------------------------------------------------------------
